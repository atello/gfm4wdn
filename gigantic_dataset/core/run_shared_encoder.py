...
from gigantic_dataset.core.train import train, eval, TrainOneEpoch, TestOneEpoch, WandbStartProfiler, SemiSingleForward, SemiSingleNNDegForward, TrainOneEpochDegreeEncoder, TestOneEpochDegreeEncoder
...
from gigantic_dataset.models.gnn_models import LoadGATRes, LoadGraphWaterSE, LoadGraphWaterSEPretrainedEncoder, \
    LoadStructuralEncoder, LoadStructuralEncoderFinetune
...
def train_shared_encoder(
    ...
    func_ref = FuncRef(
        ...
        forward_fn=MaskedSharedEncoder(),
        train_one_epoch_fn=TrainOneEpochSE(),
        test_one_epoch_fn=TestOneEpochSE(),
        train_fn=train,
        eval_fn=eval,
...
def finetune_shared_encoder(
    ...
    func_ref = FuncRef(
        ...
        load_models=LoadStructuralEncoderFinetune(),
        load_optimizers=default_load_optimizers,
        load_scheduler=default_load_scheduler,
    )
    # initialize the ConfigRef which we can call from anywhere
